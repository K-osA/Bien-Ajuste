    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(GetImageActivity.this, MeasureActivity.class);
                intent.putExtra("sizeloc",compFile.getAbsolutePath());
                GetImageActivity.this.startActivity(intent); //일단 RegisterActivity로 바로 넘어가게 하였음 추후 수정해야함
